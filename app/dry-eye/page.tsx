...
export default function DryEyePage() {
  return <>
    ...
    <main id="main-content" className="detail-page">
      ...
      <figure className="service-story-image"><Image src="/approved-assets/dry-eye-care-context.png" alt="A clinician reviewing eye-comfort questions during a dry eye consultation." width={1536} height={1024} /><figcaption><span>PATIENT REVIEW · GOOGLE</span><blockquote>“I went from using drops hourly to not needing them at all.”</blockquote><p>— William Wright, on his dry-eye care experience</p></figcaption></figure>
