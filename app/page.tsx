    ...
    <main id="main-content">
      <section className="hero">
        ...
        <nav aria-label="Primary navigation" className="nav">
          ...
          <div className="nav-links"><Link href="/our-practice">About</Link><details className="nav-menu home-nav-menu"><summary>Eye care</summary><div className="nav-groups"><section><p>Everyday eye care</p><Link href="/care/comprehensive-eye-exams">Comprehensive eye exams</Link><Link href="/care/ocular-disease-management">Medical eye care</Link><Link href="/care/myopia-management">Myopia management</Link><Link href="/care/lasik-evaluations">LASIK evaluations</Link></section><section><p>Focused care</p><Link href="/dry-eye">Dry Eye Center</Link><Link href="/specialty-contact-lenses">Specialty contact lenses</Link><Link href="/care/scleral-contact-lenses">Scleral lenses</Link><Link href="/care/optilight-ipl">OptiLight IPL</Link></section><section><p>Complete care guide</p><Link href="/services">Explore all services →</Link><Link href="/aesthetics">Ocular aesthetics →</Link></section></div></details><details className="nav-menu home-nav-menu"><summary>Specialty care</summary><div className="nav-groups nav-groups-specialty"><section><p>Dry eye</p><Link href="/dry-eye">Dry Eye Center</Link><Link href="/dry-eye-quiz">Take the Dry Eye Quiz →</Link><Link href="/care/optilight-ipl">OptiLight IPL →</Link></section><section><p>Specialty vision</p><Link href="/specialty-contact-lenses">Specialty contact lenses</Link><Link href="/care/scleral-contact-lenses">Scleral contact lenses</Link><Link href="/care/myopia-management">Myopia management →</Link></section></div></details><Link href="/eye-health">Resources</Link><a href="https://www.cosmopolitaneyecare.com/blog.html" target="_blank" rel="noreferrer">Blog ↗</a><Link href="/patient-resources">Patient center</Link><Link href="/contact">Contact</Link></div>
          ...
          <details className="mobile-menu home-mobile-menu"><summary aria-label="Open site menu"><span className="hamburger" aria-hidden="true" /></summary><div><Link href="/our-practice">About Cosmopolitan</Link><Link href="/services">All eye care services</Link><p className="mobile-menu-label">Everyday eye care</p><Link href="/care/comprehensive-eye-exams">Comprehensive eye exams</Link><Link href="/care/ocular-disease-management">Medical eye care</Link><Link href="/care/myopia-management">Myopia management</Link><Link href="/care/lasik-evaluations">LASIK evaluations</Link><p className="mobile-menu-label">Specialty care</p><Link href="/dry-eye">Dry Eye Center</Link><Link href="/dry-eye-quiz">Take the Dry Eye Quiz</Link><Link href="/specialty-contact-lenses">Specialty contact lenses</Link><Link href="/care/scleral-contact-lenses">Scleral lenses</Link><Link href="/care/optilight-ipl">OptiLight IPL</Link><Link href="/aesthetics">Ocular aesthetics</Link><Link href="/eye-health">Eye health resources</Link><a href="https://www.cosmopolitaneyecare.com/blog.html" target="_blank" rel="noreferrer">Blog &amp; articles ↗</a><Link href="/patient-resources">Patient center</Link><Link href="/contact">Contact &amp; visit</Link><a href="https://www.lenscrafters.com/webapp/wcs/stores/servlet/ScheduleExamView?catalogId=11651&langId=-1&storeId=10851&storeNumber=3725" target="_blank" rel="noreferrer">Book an appointment ↗</a></div></details>
        </nav>
        <div className="hero-copy">
          <p className="kicker">Midtown Manhattan</p>
          ...
          <Link className="text-link hero-care-link" href="/services">Explore our care <span>→</span></Link>
        </div>
      ...
      <section id="care" className="focus section-pad">
        <div className="section-intro"><div><p className="section-label">EYE CARE SERVICES</p><h2>Start with the care you <em>need.</em></h2><p>Start with what brings you in. These are Cosmopolitan’s core care pathways, with deeper guidance available for each service.</p></div></div>
        <div className="focus-list">{focusAreas.map((area, index) => <Link href={area.href} className={`focus-item${index < 3 ? " focus-item-primary" : ""}`} key={area.number}><span>{area.number}</span><div><h3>{area.title}</h3><p>{area.text}</p></div><b aria-hidden="true">↗</b><span className="sr-only">Learn more about {area.title}</span></Link>)}</div>
