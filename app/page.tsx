...
export default async function HomePage() {
  ...
  return <main id="main-content">
    ...
    <section id="practice" className="practice-credibility section-pad"><div className="practice-credibility-copy"><p className="section-label">{content.practiceEyebrow ?? "MORE TIME. CLEARER ANSWERS."}</p><h2>{content.practiceTitle ?? "Advanced eye care, with"} <em>{content.practiceEmphasis ?? "time to be heard."}</em></h2><p>{content.practiceBody ?? "From comprehensive eye exams to complex dry eye and specialty lens care, our doctors take a thorough, personal approach to every visit. We combine modern diagnostics with clear explanations and recommendations shaped around your daily life."}</p></div><SocialProofPanel /></section>
