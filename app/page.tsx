    ...
    <main id="main-content">
      <section className="hero">
        ...
        <nav aria-label="Primary navigation" className="nav">
          ...
          <div className="nav-links"><Link href="/our-practice">About</Link><Link href="/services">Eye care</Link><Link href="/dry-eye">Dry Eye Center</Link><Link href="/dry-eye-quiz">Dry Eye Quiz</Link><Link href="/aesthetics">Aesthetics</Link><Link href="/specialty-contact-lenses">Specialty lenses</Link><Link href="/patient-resources">Patient center</Link></div>
